...
app.use('/subdir', express.static(path.join(__dirname, '/public'))) // telling express that use the public directory to serve static files for requests falling under '/subdir'
